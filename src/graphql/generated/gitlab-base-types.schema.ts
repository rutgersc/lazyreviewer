...
export const AiCatalogItemVerificationLevelSchema: Schema.Schema<AiCatalogItemVerificationLevel> = Schema.Union(
...
export const AiCatalogMcpServerAuthTypeSchema: Schema.Schema<AiCatalogMcpServerAuthType> = Schema.Union(
  Schema.Literal('NO_AUTH'),
  Schema.Literal('OAUTH')
)
export const AiCatalogMcpServerTransportSchema: Schema.Schema<AiCatalogMcpServerTransport> = Schema.Union(
  Schema.Literal('HTTP')
)
...
export const AiFlowTriggerEventTypeSchema: Schema.Schema<AiFlowTriggerEventType> = Schema.Union(
...
export const CustomizableDashboardGridHeightSchema: Schema.Schema<CustomizableDashboardGridHeight> = Schema.Union(
...
export const SecretStatusSchema: Schema.Schema<SecretStatus> = Schema.Union(
  Schema.Literal('COMPLETED'),
...
export const SecurityTrackedRefScopeSchema: Schema.Schema<SecurityTrackedRefScope> = Schema.Union(
  Schema.Literal('ALL_REFS'),
  Schema.Literal('DEFAULT_BRANCHES')
)
export const SecurityTrackedRefStateSchema: Schema.Schema<SecurityTrackedRefState> = Schema.Union(
  Schema.Literal('TRACKED'),
  Schema.Literal('UNTRACKED')
)
export const SecurityTrackedRefTypeSchema: Schema.Schema<SecurityTrackedRefType> = Schema.Union(
  Schema.Literal('BRANCH'),
  Schema.Literal('TAG')
)
