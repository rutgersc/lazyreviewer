...
export type MergeRequestStampFieldsFragment = { readonly id: string, readonly iid: string, readonly updatedAt: string, readonly state: Types.MergeRequestState, readonly detailedMergeStatus: Types.DetailedMergeStatus | null, readonly autoMergeEnabled: boolean, readonly diffHeadSha: string | null, readonly approvedBy: { readonly nodes: ReadonlyArray<{ readonly id: any } | null> | null } | null, readonly headPipeline: { readonly iid: string, readonly jobs: { readonly nodes: ReadonlyArray<{ readonly name: string | null, readonly status: Types.CiJobStatus | null, readonly retried: boolean | null } | null> | null } | null } | null };
