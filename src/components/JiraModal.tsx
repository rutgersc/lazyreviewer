  ...
  return (
    ...
    >
      ...
      <box style={{ padding: 1, border: true, borderColor: '#6272a4', backgroundColor: '#44475a' }}>
        <text style={{ fg: '#f8f8f2', attributes: TextAttributes.BOLD }} wrap={false}>
      ...
      <box style={{ flexDirection: 'column', padding: 1, flexGrow: 1 }}>
        {jiraIssues.length === 0 ? (
          <text style={{ fg: '#6272a4', attributes: TextAttributes.DIM }} wrap={false}>
            ...
            {jiraIssues.map((issue, index) => (
              <box key={issue.key} style={{ flexDirection: 'column', gap: 0 }}>
                ...
                <box style={{ flexDirection: 'row', gap: 1, alignItems: 'center' }}>
                  <text style={{ fg: '#50fa7b', attributes: TextAttributes.BOLD }} wrap={false}>
                    {issue.key}
                  </text>
                ...
                <box style={{ flexDirection: 'row', gap: 2, marginLeft: 2 }}>
                  ...
                  <text style={{ fg: '#ffb86c', attributes: TextAttributes.DIM }} wrap={false}>
                ...
                <box style={{ marginLeft: 2 }}>
                  <text style={{ fg: '#8be9fd', attributes: TextAttributes.DIM }} wrap={false}>
                ...
                {index < jiraIssues.length - 1 && (
                  <box style={{ marginTop: 1, marginBottom: 1 }}>
                    <text style={{ fg: '#44475a' }} wrap={false}>
                      {'─'.repeat(50)}
                    </text>
                  </box>
                )}
